...
#ifndef NGINX_LEARNING_NGX_LOG_H
#define NGINX_LEARNING_NGX_LOG_H
...
struct ngx_log_s {
    ngx_uint_t           log_level;//日志级别或者日志类型  默认为NGX_LOG_ERR
    ngx_open_file_t     *file;//日志文件

    ngx_atomic_uint_t    connection;//日志关联的连接计数，不为O时会输出到日志中
...
#endif //NGINX_LEARNING_NGX_LOG_H
